...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --set-secrets BINANCE_API_KEY=binance-api-key:latest,BINANCE_PRIVATE_KEY=binance-private-key:latest,TWILIO_ACCOUNT_SID=twilio-account-sid:latest,TWILIO_AUTH_TOKEN=twilio-auth-token:latest \
